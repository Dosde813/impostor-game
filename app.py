...
app = Flask(__name__)
app.secret_key = "impostor_elite_v2_4_final"
socketio = SocketIO(app, cors_allowed_origins="*", async_mode='eventlet')

# DICCIONARIO INTERNACIONAL (Objetos universales)
DICCIONARIO_TOTAL = {
...
<head>
    ...
    <title>Impostor Elite v2.4</title>
...
<body>
    ...
    <script>
        ...
        let miToken = localStorage.getItem('elite_tk_v24');
        let miNombre = localStorage.getItem('elite_nm_v24');
        ...
        function registrar() {
            ...
            if(n) {
                ...
                localStorage.setItem('elite_tk_v24', miToken);
                localStorage.setItem('elite_nm_v24', miNombre);
            ...
            if(!data.encendido) {
                ...
                if(!miNombre) {
                    if(data.estado === 'juego') {
                        document.getElementById('sec-espera').classList.remove('hidden');
                    } else {
...
def iniciar():
    ...
    # BLOQUEO SILENCIOSO PARA LOS QUE LLEGAN TARDE
...
def finalizar():
    ...
    # LIBERACIÓN SILENCIOSA: La pantalla de Miguel cambia SOLA a Registro
